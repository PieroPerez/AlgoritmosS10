...
public class BNode<E extends Comparable<E>> {
     ...
     * @return Un arreglo de dos elementos:
     *   [0] true si encontró la clave, false si no.
     *   [1] posición donde está la clave (si se encontró)
     *       o la posición del hijo donde debe descender (si no se encontró).
     */
